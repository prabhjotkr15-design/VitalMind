...
app.get('/', (req, res) => res.send(readFileSync('./pages/home.html', 'utf-8')));
...
app.get('/callback', async (req, res) => {
  ...
  try {
    ...
    res.redirect('/onboarding?data=' + whoopEncoded);
  } catch (err) {
...
app.get('/onboarding', (req, res) => {
  const html = readFileSync('./pages/onboarding.html', 'utf-8');
...
app.get('/insights', async (req, res) => {
  try {
    ...
    let html = readFileSync('./pages/insights.html', 'utf-8');
    html = html
