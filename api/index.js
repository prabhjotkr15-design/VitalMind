...
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>VitalMind — Analyzing</title>
  <link href="https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=DM+Sans:wght@300;400;500&display=swap" rel="stylesheet"/>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    body {
    ...
    p { color: #6b7a99; font-size: 16px; }
    strong { color: #00e5ff; font-family: 'Syne', sans-serif; }
  </style>
</head>
<body>
  <div class="pulse">
    <div class="spinner"></div>
    <p><strong>Analyzing your WHOOP data...</strong></p>
    <p style="margin-top:8px;font-size:14px;">This takes about 10 seconds</p>
  </div>
</body>
</html>`);
  ...
  try {
    ...
    const claudeRes = await axios.post(
      'https://api.anthropic.com/v1/messages',
      {
        ...
        messages: [{
          role: 'user',
          content: `You are a personal health coach. Analyze this WHOOP data from the past 7 days. Format your response in clean HTML using only <h2>, <h3>, <p>, <ul>, <li>, <strong>, and <table> tags. Use emojis sparingly. Give specific insights with actual numbers from the data. End with exactly 3 concrete actions in a <ul>.
...
document.close();
    ...
    res.end(`<script>document.write('Error: ${JSON.stringify(err.message)}')</script>`);
  }
});
